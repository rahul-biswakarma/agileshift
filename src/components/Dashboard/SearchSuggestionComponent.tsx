...
const SearchSuggestionComponent = ({ data }: Type_SuggestionsProps) => {
  ...
  return (
    <div
      className="w-full max-w-full p-2 rounded-md hover:bg-sidebar_bg hover:text-highlight_font_color flex items-center cursor-pointer 
    ...
    >
      ...
      <button className="p-[0.10rem_0.60rem] flex items-center bg-Secondary_background_color border border-inherit text-center text-lg rounded-lg">
