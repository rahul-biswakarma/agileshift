...
const DisplayIdComponent = (props: Type_DisplayIdComponentProps) => {
  ...
  return (
    <div
      ...
      className="w-max min-w-fit h-[20px] font-fira_code rounded-md text-blue-600 text-center px-[8px] py-[12px] flex justify-center items-center text-[12px] font-[500]  uppercase"
    >
