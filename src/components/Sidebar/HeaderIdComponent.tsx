...
const HeaderIdComponent = (props:Type_HeaderIdComponentProps) => {
    return (
        props.state.data?
            <span style={{borderColor:props.state.color, color:props.state.color, backgroundColor:props.state.color+20}} className={`border-2 px-1 rounded-md text-sm flex items-center`}>
                {props.state.data.id}
            </span>:
            <span style={{borderColor:props.state.color, color:props.state.color, backgroundColor:props.state.color+20}} className={`border-2 px-1 rounded-md text-sm flex items-center`}>
