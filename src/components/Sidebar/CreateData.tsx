...
export default function CreateData(props: Props) {
	...
	if (props.tabColaps) {
		...
		return (
			<div className="w-[400px] p-4 flex flex-col justify-start h-screen bg-sidebar_bg backdrop-filter backdrop-blur-md bg-opacity-10 
					...
					{(props.sidebar.sidebarType === "createMode" ||
						...
						<Select
							style={{
								...
								backgroundColor: `${formSchema && formSchema.color?get_background_color_from_name(formSchema.color):"#FFFFFF"}30`,
								borderRadius:"0.375rem",
								boxShadow: "none",
							}}
							sx={{ boxShadow:0, border: 0, '.MuiOutlinedInput-notchedOutline': { border: 0 } }}
							value={selectedField}
				...
				<div className="grow overflow-y-auto my-2">
					<div
						style={{
							background:`${formSchema?get_background_color_from_name(formSchema.color):"#FFFFFF"}35`,
							borderColor: formSchema?get_text_color_from_name(formSchema.color):"#FFFFFF",
						}}
					...
					<div className="my-4">
						...
						<section
							className="flex flex-wrap gap-2 justify-center cursor-pointer mt-4 mb-4 p-2 py-4 border-y rounded-lg bg-black/60 border-black"
						>
