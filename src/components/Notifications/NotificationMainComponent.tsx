...
import { get_data_byID, get_schema_data_field, mark_notification_seen, update_notification } from '../../Utils/Backend';
...
const NotificationMainComponent = (props:TYPE_NotificationProps) => {
    ...
    const handleClearAllNotification = async () =>{
        ...
        const notificationListSeen =await Promise.all(notificationList.map(async (notification:TYPE_NotificationData)=>{
        ...
        <div className="grow flex flex-col">
            <div className='relative bg-Secondary_background_color flex justify-between p-[1rem_2rem]'>
                ...
                <div className='flex gap-3'>                  
                  <button className='font-dm_sans text-[1rem] flex gap-[0.2rem] text-white/30 cursor-pointer rounded-sm hover:text-white' onClick={()=>handleClearAllNotification()}>
