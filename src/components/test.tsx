        ...
        <div className='flex justify-between mb-4 mx-9 pt-4'>
            <div className='flex flex-wrap'>
                ...
                <div className='flex items-center'>
                    <button className='rounded-md h-7 w-16 border border-1 border-[#808080] text-[#808080] text-sm mr-4'>Owner</button>
                </div>
                <div className='flex items-center'>
                    <button className='rounded-md h-7 w-16 border border-1 border-[#808080] text-[#808080] text-sm mr-4'>Priority</button>
                </div>
                <div className='flex items-center'>
                    <button className='rounded-md h-7 w-16 border border-1 border-[#808080] text-[#808080] text-sm mr-4'>Rev Org</button>
                </div>
                <div className='flex items-center'>
                    <button className='rounded-md h-7 w-16 border border-1 border-[#808080] text-[#808080] text-sm mr-4'>Severity</button>
                </div>
