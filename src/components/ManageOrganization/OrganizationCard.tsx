	...
	return (
		...
		>
			<div className="flex gap-[1rem] items-center">
				<span className={`${iconSize} material-symbols-outlined text-white/50 cursor-pointer`}>
					cyclone
				</span>
			...
			{!pendingInvitation ? ( 
				...
				>
					<span className={`${fontSize} material-symbols-outlined`}>arrow_forward</span>
				</button>	
			) : (
				<React.Fragment>
					...
					<div className="flex gap-[1rem] border-transparent">
						...
						>
							<span className={`${fontSize} material-symbols-outlined`}>check</span>
						</button>
						<button
						...
						>
							<span className={`${fontSize} material-symbols-outlined`}>close</span>
						</button>
					</div>
				</React.Fragment>
			)}
