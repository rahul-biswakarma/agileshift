    ...
    <div>
      <div className="flex my-[0.3rem] bg-background_color text-sm rounded-lg">
        ...
        <input
          ...
          className="grow h-[2.5rem] bg-Secondary_background_color focus:outline-none rounded-r px-4 code-font font-dm_sans text-white border-2 border-background_color placeholder:text-primary_font_color"
          type="date"
